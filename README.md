...
All experiments were performed on the **Alibaba Cloud Elastic GPU** platform [[@AlibabaCloudEGS]: https://www.aliyun.com/product/egs "Alibaba Cloud Elastic GPU Service"] using **NVIDIA A10** GPUs (24 GB memory). The software environment was Python 3.9, PyTorch 2.0.0, and CUDA 11.8.
