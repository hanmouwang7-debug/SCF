...
![Framework Overview](outputs/samples/framework_overview.png)

**Figure 1 | Overview of the landscape preconditioning framework for high-resolution SCF prediction.**  
**(a)** Multi-source environmental inputs and preprocessing, including topographic, satellite-derived vegetation, and meteorological variables; **(b)** Deep learning architectures evaluated for SCF prediction, including encoder–decoder CNNs, high-resolution CNNs, and transformer-based models; **(c)** High-resolution SCF prediction generated by the proposed framework.
